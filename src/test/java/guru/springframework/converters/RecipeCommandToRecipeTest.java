...
public class RecipeCommandToRecipeTest {
    ...
    public void convert() {
        ...
        // when we convert a recipe command object into a recipe
        Recipe recipe = converter.convert(recipeCommand);

        // then assert that these properties are equal to what was on the recipe command object before conversion
